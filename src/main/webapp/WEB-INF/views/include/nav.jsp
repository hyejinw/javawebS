...
<script>
	...
	function memberDelete() {
		...
		if(!ans) return false;
			...
			ans = confirm('탈퇴 후 1개월 동안 같은 아이디로 재가입이 불가합니다.\n그래도 탈퇴하시겠습니까?');
			if(!ans) return false;
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <!-- <a href="http://192.168.50.83:9090/javawebS" class="w3-bar-item w3-button w3-padding-large">HOME</a> -->
   	...
   	<c:if test="${sLevel <= 3}">
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        ...
	        <a href="${ctp}/study/fileUpload/fileUploadForm" class="w3-bar-item w3-button">파일 업로드연습</a>
	      </div>
	    </div>
	    <div class="w3-dropdown-hover w3-hide-small">
