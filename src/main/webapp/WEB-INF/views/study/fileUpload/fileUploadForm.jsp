...
<div class="container">
  ...
  <hr/>
  <input type="button" value="저장된 파일보기" id="fileViewBtn" class="btn btn-info" />
	  	...
	  	<c:forEach var="file" items="${files}" varStatus="st">
	  		<tr>
	  			...
	  			<td>
	  				...
	  				<input type="button" value="삭제2" onclick="fileDelete('${file}')" class="btn btn-danger btn-sm"/>
					</td>
	  		</tr>
	  	</c:forEach>
